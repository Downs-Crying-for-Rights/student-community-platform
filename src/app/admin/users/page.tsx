          ...
          <div className="space-y-6">
            ...
            {isSuperAdmin && <div className="space-y-4 rounded-lg border bg-background/95 p-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="space-y-1 text-sm"><span className="font-medium">头像</span><div><Button type="button" size="sm" variant="outline" disabled={!profileForm.avatar} onClick={() => setProfileForm((form) => ({ ...form, avatar: "" }))}><X className="h-4 w-4" />清除头像</Button></div></div>
              </div>
